...
# CLASE 4: ESTRUCTURAS DE CONTROL. RMD
...
# CLASE 5: COMUNICANDO RESULTADOS. ENTREGA I

&nbsp;

### [informes/apuntes: rmarkdown](#rmd)

### [Caso práctico: starwars](#clase5-caso-I)

### [Caso práctico: gapminder](#clase5-caso-II)
...
# .orange[CASO PRÁCTICO]: análisis de gapminder
...
Dicho paquete pretende imitar lado **.bg-purple_light[programación funcional]** de otros lenguajes como Scala o la **estrategia map-reduce de Hadoop** (de Google).
...
# CLASE 7: IMPORTAR/EXPORTAR. TIDYDATA
...
### [Caso I: datos electorales (tidydata)](#clase8-caso-I)

### [Caso II: starwars (continuación)](#clase8-caso-II)

### [Caso III: análisis de los datos covid del ISCIII](#clase8-caso-III)
...
# CLASE 11: tidyverse y generación de resúmenes
...
# CLASE 13: uso de factores con forcats
...
# CLASE 14: introducción a ggplot

...
# CLASE 6: mejorando nuestro código
...
Otra manera de diseñar un bucle es con la estructura `while { }`, que ejecutará el bucle un **.bg-purple_light[número de veces pero que a priori es desconocido]**, lo hará **.bg-orange[hasta que la condición impuesta]** deje de ser `TRUE`. Por ejemplo, vamos a inicializar una variable `ciclos <- 1`, y en cada paso aumentaremos una unidad, y no saldremos del bucle hasta que `ciclos > 4`
...
# CLASE 7: funciones y listas. Importar/exportar datos. 
...
### [Caso práctico: análisis de los datos del ISCIII](#clase8-entrega)
...
# CLASE 9: introducción al tidydata
...
# CLASE 10: primer uso de tidyverse

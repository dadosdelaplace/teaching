...
### [Introducción al aprendizaje estadístico y minería: metodología SEMMA](#learning)
...
* **.bg-purple_light[Output real]** que llamaremos $Y = f(X) + \varepsilon$
...
* **Ruido**: error aleatorio **irreducible** $\varepsilon$ (la componente aleatoria del modelo no determinístico) de media nula.

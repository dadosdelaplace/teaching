...
- Metodologías de **.bg-purple_light[aprendizaje supervisado]**:
  ...
  - **.bg-orange[Regresión penalizada]**: ¿todas las variables son importantes? ¿Podemos penalizar incluir información superflua?
  
  - **.bg-orange[Regresión logística]**: realizaremos una predicción continua de la probabilidad de que una variable cualitativa tome cada una de las categorías (probabilidad de estar sano o enfermo, por ejemplo).
  
  - **.bg-orange[GLM]**: generalizaremos los modelos lineales vistos hasta ahora (logística y reg. lineal).
...
#### [CLASE 3: INTRO A LA METODOLOGÍA SEMMA. ESTRUCTURAS DE CONTROL Y FUNCIONES. RMD](#clase-3)
...
Las **.bg-purple_light[medidas de posición]** nos **localizan** los datos: son **.bg-purple_light[valores que nos dividen]** un conjunto ordenado en un número de tramos con el mismo tamaño muestral.
...
Ejemplo: la mediana es el percentil $P_{50}$, el decil $D_{5}$ y el cuartil $C_{2}$ o $q_2$.
...
# CLASE 3: introducción a SEMMA. Estructuras de control y funciones. Rmd.

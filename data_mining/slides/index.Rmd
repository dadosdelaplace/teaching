...
# Ejercicios (estratificado y group_by() + count())
...
* 📝 **Ejercicio 2**: tras eliminar ausentes en las variables `birth_year`, obtén la edad mínima y máxima de cada sexo.

* 📝 **Ejercicio 3**: obtén el personaje más viejo por cada sexo.

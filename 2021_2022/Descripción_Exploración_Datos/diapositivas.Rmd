...
**Javier Álvarez Liébana**, nacido en un año indeterminado en **Carabanchel** (Madrid).

<img src = "http://bit.ly/wiki-toddy" width = "25%" align = "right" />

--

(no, Manolito Gafotas era de Carabanchel Bajo)

--

**Un poco de CV**: licenciatura de Matemáticas (UCM), máster en Ingeniería Matemática (UCM), Doctor en Estadística (UGR), Ayudante Doctor en UNIOVI y UCM

--

**Divulgando cuando puedo** 👇🏻
...
🗓 **HORARIO**: lunes de 13:00 a 15:00; jueves de 11:00 a 13:00.  
🏫 **Tutorías**: 12:00-13:00 lunes; 13:00-14:00 y 17:00-18:00 jueves.
...
### Telegram
Usaremos un [grupo de Telegram](t.me/exploracion_datos_2021_2022) como foro de la clase para la **comunicación del día a día**, así como dudas rápidas.
...
- **Evaluación continua**: participación en clase y trabajo realizado durante el curso (problemas y posibles entregas de prácticas).

- **Nota final**: se ponderará un **35% la evaluación continua** y un **65% la calificación de un examen final**. La nota final será el **máximo entre esta ponderación y dicho examen**. Ejemplos: continua 9/10 + examen final 5/10 = nota final 6.4/10; continua 5/10 + examen final 1/10 = nota final 5/10 (ponderación 3.6/10 pero 5/10 en la prueba final).

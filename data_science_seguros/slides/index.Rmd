...
# COMPLEMENTOS A MIRAR EN CASA

&nbsp;

#### [Presentar resultados: rmd](#rmd)

#### [Ejercicios a entregar](#ejercicios-I)
...
# Ejercicios a entregar (10%)

Deberás **.bg-purple_light[entregar completado]** un archivo `.R` (o bien el archivo `.Rmd` que tienes disponible en <https://github.com/dadosdelaplace/teaching/tree/main/data_science_seguros/eval>) con los ejercicios resueltos **.bg-purple_light[antes de las 17:59 del 25 de octubre]**.
...
* 📝 **Ejercicio 3**: repite el ejercicio anterior pero tras la conversión a tidydata, elimina datos ausentes (deberías obtener un dataset de 5307 filas y 5 columnas). Tras ello, selecciona solo aquellos registros del primer año natural (de la semana 1 a la semana 52), y elimina la variable `date.entered`.
...
🔎 Mira antes <https://github.com/dadosdelaplace/teaching/blob/main/data-science_seguros/scripts/segundo_rmarkdown.Rmd> para ver algunas opciones extras que puedes usar para personalizar.

...
Con la tabla del ejercicio 3 ejecuta este código (cambia la columna key por la corresponda en tu caso concreto)
...
> Aunque es de tidyverse que aún no sabemos, haciendo uso de `select()`, mirando la chuleta del paquete `{dplyr}`, ¿sabrías como eliminar dos de las 3 columnas redundantes de país?

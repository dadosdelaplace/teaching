...
> Acude a la web <https://cnecovid.isciii.es/covid19/#documentaci%C3%B3n-y-datos> e importa el fichero `casos_hosp_uci_def_sexo_edad_provres.csv` (click derecho para "copiar enlace"). Tienes la documentación de los datos en <https://cnecovid.isciii.es/covid19/resources/metadata_casos_hosp_uci_def_sexo_edad_provres.pdf>
